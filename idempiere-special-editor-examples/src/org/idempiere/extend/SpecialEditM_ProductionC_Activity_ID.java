 ...
 *
 */
public class SpecialEditM_ProductionC_Activity_ID implements ISpecialEditCallout {
	...
	public boolean preEdit(GridTab mTab, GridField mField, PO po) {
		...
		SpecialEditorUtils.deletePosting(new MProduction(Env.getCtx(), (Integer) mTab.getValue("M_Production_ID"), null));
		return true;
	}
	...
	public boolean updateEdit(GridTab mTab, GridField mField, PO po, Object newValue) {
		...
		X_M_Production pro = new X_M_Production(Env.getCtx(), mTab.getRecord_ID(), null);
		pro.setC_Activity_ID((Integer) newValue);
		pro.saveEx();
		return true;
	}
	...
	public boolean postEdit(GridTab mTab, GridField mField, PO po) {
		...
		// Repost invoice
		SpecialEditorUtils.post(mTab, new MProduction(Env.getCtx(), (Integer) mTab.getValue("M_Production_ID"), null));
