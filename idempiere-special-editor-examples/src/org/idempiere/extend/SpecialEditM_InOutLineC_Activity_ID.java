 ...
 *
 */
public class SpecialEditM_InOutLineC_Activity_ID implements ISpecialEditCallout {
	...
	public boolean updateEdit(GridTab mTab, GridField mField, PO po, Object newValue) {
		...
		X_M_InOutLine mil = new X_M_InOutLine(Env.getCtx(), mTab.getRecord_ID(), null);
		mil.setC_Activity_ID((Integer) newValue);
		mil.saveEx();
		return true;
	}
