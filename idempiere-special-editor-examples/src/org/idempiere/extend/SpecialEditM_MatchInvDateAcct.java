...
public class SpecialEditM_MatchInvDateAcct implements ISpecialEditCallout {
	...
	public String validateEdit(GridTab mTab, GridField mField, PO po, Object newValue) {
		...
		X_M_MatchInv mat = new X_M_MatchInv(Env.getCtx(), mTab.getRecord_ID(), null);
		Timestamp DateEntered = (Timestamp) newValue ;
		Timestamp DateAcct = mat.getDateAcct();
		...
		Timestamp actualDateAcct = mat.getDateAcct();
	...
	public boolean preEdit(GridTab mTab, GridField mField, PO po) {
		...
		//  Delete Posting
		SpecialEditorUtils.deletePosting(new MMatchInv(Env.getCtx(), (Integer) mTab.getValue("M_MatchInv_ID"), null));
		return true;
	}
	...
	public boolean updateEdit(GridTab mTab, GridField mField, PO po, Object newValue) {
		...
		X_M_MatchInv mat = new X_M_MatchInv(Env.getCtx(), mTab.getRecord_ID(), null);
		mat.setDateAcct((Timestamp) newValue);
		mat.saveEx();
		return true;
	}
	...
	public boolean postEdit(GridTab mTab, GridField mField, PO po) {
		// Repost invoice
		SpecialEditorUtils.post(mTab, new MMatchInv(Env.getCtx(), (Integer) mTab.getValue("M_MatchInv_ID"), null));
		//Refresh
